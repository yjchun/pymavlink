...
PROTOCOL_MARKER_V1 = const(0xFE)
PROTOCOL_MARKER_V2 = const(0xFD)
HEADER_LEN_V1 = const(6)
HEADER_LEN_V2 = const(10)

MAVLINK_SIGNATURE_BLOCK_LEN = const(13)

MAVLINK_IFLAG_SIGNED = const(0x01)

native_supported = False # Not yet supported on other dialects
native_force = False # Will force use of native code regardless of what client app wants
native_testing = False # Will force both native and legacy code to be used and their results compared
...
MAVLINK_IGNORE_CRC = 0

# some base types from mavlink_types.h
MAVLINK_TYPE_CHAR     = const(0)
MAVLINK_TYPE_UINT8_T  = const(1)
MAVLINK_TYPE_INT8_T   = const(2)
MAVLINK_TYPE_UINT16_T = const(3)
MAVLINK_TYPE_INT16_T  = const(4)
MAVLINK_TYPE_UINT32_T = const(5)
MAVLINK_TYPE_INT32_T  = const(6)
MAVLINK_TYPE_UINT64_T = const(7)
MAVLINK_TYPE_INT64_T  = const(8)
MAVLINK_TYPE_FLOAT    = const(9)
MAVLINK_TYPE_DOUBLE   = const(10)


# micropython do not implement struct.Struct and struct.error
class struct_Struct:
...
def generate_message_ids(outf, msgs):
    ...
    for m in msgs:
        outf.write("MAVLINK_MSG_ID_%s = const(%u)\n" % (m.name.upper(), m.id))
...
class MAVLink(object):
        ...
        def __init__(self, file, srcSystem=0, srcComponent=0, use_native=False):
                ...
                self.mav20_unpacker = struct_Struct('<cBBBBBBHB')
                self.mav10_unpacker = struct_Struct('<cBBBBB')
                self.mav20_h3_unpacker = struct_Struct('BBB')
                self.mav_csum_unpacker = struct_Struct('<H')
                self.mav_sign_unpacker = struct_Struct('<IH')
